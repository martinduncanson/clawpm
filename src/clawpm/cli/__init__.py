...
# agent_context (the top-level `context` command, now in cli.shortcuts) is
# invoked by project_context, still defined in this module until the project
# group is extracted.
from clawpm.cli.shortcuts import agent_context  # noqa: F401
